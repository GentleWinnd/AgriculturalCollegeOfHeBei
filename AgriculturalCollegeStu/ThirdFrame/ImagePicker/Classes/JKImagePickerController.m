...
- (void)cropImageView {
    CropImageViewController *cropView = [[CropImageViewController alloc] init];
    cropView.imagesArr = self.selectedAssetArray;
    cropView.navigationController.navigationBarHidden = YES;
