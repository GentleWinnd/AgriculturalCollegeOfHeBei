...
+ (void)creatPlist {
    ...
    if (role == UserRoleTeacher) {
         plistPath = [documentDirectory stringByAppendingPathComponent:@"AgriculturalUniversityTaecherCache.plist"];
    } else {
        plistPath = [documentDirectory stringByAppendingPathComponent:@"AgriculturalUniversityStudentCache.plist"];
    }
...
+ (NSString *)getLibraryCachePath {
    ...
    UserRole role = [UserData getUser].userRole;
    if (role == UserRoleTeacher) {
        plistPath = [libraryCacheDirectory stringByAppendingPathComponent:@"AgriculturalUniversityTaecherCache.plist"];
    } else {
        plistPath = [libraryCacheDirectory stringByAppendingPathComponent:@"AgriculturalUniversityStudentCache.plist"];
    }
    return plistPath;
}
